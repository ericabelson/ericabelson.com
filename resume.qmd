...
-   Build research and industry solutions using the R programming language (with experience in Python)
-   Use of advanced quantitative statistical and machine learning methods and geospatial analytical techniques
...
+----------------------------------------------------------------+--------------------------------------------------------------+---------------------------------------------+------------------------------------------------------+
| **University of Texas, Austin**                                | Program Manager \| Research Scientist/Fellow \| 2020-Present |                                             |                                                      |
+----------------------------------------------------------------+--------------------------------------------------------------+---------------------------------------------+------------------------------------------------------+
|                                                                |                                                              | **USDA Pacific Southwest Research Station** | Program Manager \| Postdoctoral Scholar \| 2015-2020 |
+----------------------------------------------------------------+--------------------------------------------------------------+---------------------------------------------+------------------------------------------------------+
| **University of California, Los Angeles**                      | Program Manager \| Postdoctoral Fellow                       | 2014-2015                                   |                                                      |
+----------------------------------------------------------------+--------------------------------------------------------------+---------------------------------------------+------------------------------------------------------+
